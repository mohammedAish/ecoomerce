                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="tb_right pull-right">
                                    <ul>
                                        <li>
                                            <div class="tbr-info">
                                                 <span>Account :: Hi,{{Auth::user()->name}}<i class="fa fa-caret-down"></i></span>
                                                <div class="tbr-inner">
                                ...
                                <div class="product-item">
                                    <div class="item-thumb">
                                        ...
                                        <div class="product-overlay">
                                            ...
                                            <a href="" data-postid="#myModal" class="fa fa-heart-o" onclick="like('{{$row->id}}')"></a> 
...
<script type="text/javascript">
 ...
 function like(id){
    ...
    $.ajax({
        ...
        data: { post_id: post_id, _token: "{{ Session::token() }}" },
